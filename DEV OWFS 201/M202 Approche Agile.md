...
## <span style="color: rgb(255 100 100)">Partie 1: Connaître les fondamentaux de la gestion de projet</span>:
### <span style="color: rgb(50 200 50)">Chapitre 1: Découvrir les Concepts de gestion de projet</span>:
#### <span style="color: rgb(10 150 255)">1. <span style="text-decoration: underline">Concepts</span> de gestion de projet</span>:
- <span style="color: cyan">**Projet**</span>: Un effort ponctuel visant un objectif unique, avec début/fin, ressources et budget.
- (مشروع: جهد مؤقت له هدف فريد وبداية ونهاية وموارد وميزانية.)
- <span style="color: cyan">**Gestion de projet**</span>: Organisation et coordination temporaires des ressources pour atteindre les objectifs du projet.
- (إدارة المشروع: تنظيم وتنسيق الموارد مؤقتًا لتحقيق أهداف المشروع.)
- <span style="color: cyan">**Ressource**</span>: Élément nécessaire à l’exécution (personne, matériel, argent, temps, info).
- (المورد: عنصر ضروري للتنفيذ — شخص، معدات، مال، وقت، معلومات.)
- <span style="color: cyan">**Charte de projet**</span>: Document court autorisant et définissant objectifs, périmètre et parties prenantes.
- (ميثاق المشروع: وثيقة مختصرة تفوض المشروع وتحدد الهدف والنطاق والأطراف المعنية.)
#### <span style="color: rgb(10 150 255)">2. Parties <span style="text-decoration: underline">prenantes</span> de projet</span>:
- <span style="color: cyan">**Partie prenante**</span>:  oute personne ou organisation ayant un intérêt dans le projet, étant affectée par lui ou pouvant l’influencer
- صاحب مصلحة = أي شخص أو جهة لها علاقة بالمشروع أو تتأثر به أو تؤثّر فيه
##### <span style="color: cyan">Acteurs externes</span>:

| Clients                                                       | Fournisseurs                                    | Communautés d’utilisateurs,<br>fans                    | Organismes privés                         | Investisseurs                                          |
| ------------------------------------------------------------- | ----------------------------------------------- | ------------------------------------------------------ | ----------------------------------------- | ------------------------------------------------------ |
...
#### <span style="color: rgb(10 150 255)">3. Principaux <span style="text-decoration: underline">rôles</span> dans un projet informatique <span style="color: cyan">(Matrice RACI)</span></span>:
- <span style="color: cyan">Le chef de projet informatique**(CPI)**</span>: Responsable de la planification, coordination et suivi d’un projet IT pour livrer le produit dans les délais et le budget.
##### <span style="color: cyan">Matrice RACI</span>:

| R (Responsible)<br>fr(Réalisateur) | A (Accountable)<br>fr(Approbateur) | C (Consulted)<br>fr(Consulté)   | I(Informed)<br>fr(Informé)                          |
| ---------------------------------- | ---------------------------------- | ------------------------------- | --------------------------------------------------- |
| -من ينفذ المهمة.<br>(1 - *)        | -من يوقّع ويأخذ القرار.<br>(1 - 0) | -يُستشار قبل القرار.<br>(0 - *) | المُطّلع: يُخبَر بالتطورات دون استشارة .<br>(0 - *) |
![[m202-matrice-RACI-exp.png]]

#### <span style="color: rgb(10 150 255)">4. <span style="text-decoration: underline">Caractéristiques</span> de base d’un projet</span>
- <span style="color: cyan">**Objectifs clairs**</span> : Chaque projet doit avoir des objectifs bien définis répondant à un besoin spécifique.  
    (كل مشروع يجب أن تكون له أهداف واضحة تستجيب لحاجة معيّنة.)

- <span style="color: cyan">**Limite dans le temps**</span> : Un projet a toujours un début et une fin, marquée par l’atteinte de l’objectif.  
    (للمشروع بداية ونهاية مرتبطة بتحقيق الهدف.)
    
- <span style="color: cyan">**Activités et processus**</span> : Une activité transforme les ressources (travail, savoir, équipements, matières, temps) en résultats. Plusieurs activités forment un processus.  
    (النشاط هو ما يحوّل الموارد إلى نتائج، وغالبًا ما نحتاج سلسلة أنشطة = عملية.)
    
- <span style="color: cyan">**Ressources**</span> : Ce sont l’argent, le personnel, le matériel, mais aussi le temps, la connaissance, l’infrastructure et la communication.  
    (الموارد هي كل ما يُستعمل لتحقيق النتائج: مال، وقت، معرفة، أشخاص، معدات، إلخ.)
    
- <span style="color: cyan">**Résultats attendus**</span> : Biens ou services produits grâce aux activités, menant à l’atteinte de l’objectif spécifique.  
    (النتائج المتوقعة هي منتجات أو خدمات يقود تحقيقها إلى الهدف النهائي.)
    

#### <span style="color: rgb(10 150 255)">5. <span style="text-decoration: underline">Contraintes</span> dans la gestion d’un projet</span>: 

- <span style="color: cyan">**Contraintes de délais**</span> : Le projet doit être terminé dans une fenêtre temporelle donnée.
...
- <span style="color: cyan">**Contraintes de coûts**</span> : Budget alloué au projet, équilibre financier et rentabilité.  
...
- <span style="color: cyan">**Cascade**</span> : chaque phase doit être terminée avant de passer à la suivante. 
	   - Avantage = plan clair. 
	- Inconvénient = peu flexible.
![[m202-methode-cascade.png]]
- <span style="color: cyan">**Cycle en Y**</span> : approche unifiée (branche fonctionnel + branche technique).
	   - Avantage = plan flexible. 
	- Inconvénient = complexe.
![[m202-methode-Y.png]]
                
- <span style="color: cyan">**Cycle en V**</span> : chaque étape de conception a une phase de validation correspondante. 
	  - Avantage = rigoureux et clair.
	  - Inconvénient = effet tunnel (faible adaptation).
![[m202-methode-V.png]]

#### <span style="color: rgb(10 150 255)">2. Méthodes imprévisibles</span> (Agiles)
#####  <span style="color: cyan">Les 4 valeurs agiles</span>:
![[m202-methode-Agile-les-4-valeurs.png]]

| الشرح بالعربية                                                                  |
| ------------------------------------------------------------------------------- |
| الأفراد والتفاعل أهم من الأداة نفسها (الأدوات تُسهِّل لكن البشر يحلون المشكلات) |
| برنامج يعمل أهم من وثائق ضخمة غير مستعملة (لكن الوثائق “الكافية” مطلوبة)        |
| تعاون حيّ مع العميل أهم من التمسك الجامد بالعقد                                 |
| التعديل الذكي مع التغير أهم من تنفيذ خطة قديمة حرفياً                           |

#####  <span style="color: cyan">Les 12 principes</span>:
![[m202-methode-Agile-les-12-principes.png]]
#### <span style="color: rgb(10 150 255)">3. Comparaison</span>

- **Traditionnelles** : focalisé sur le processus, peu de place à l’adaptation.
- **Agile** : focalisé sur le produit, flexible, adapté aux besoins changeants.
## <span style="color: rgb(255 100 100)">Partie 2: Planifier un projet</span>:
...
## <span style="color: rgb(255 100 100)">Partie 3: Adopter l ’approche Agile dans gestion de projet</span>:
...
## <span style="color: rgb(255 100 100)">Partie 4: Mettre en œuvre des outils de gestion de versions et de mesure de la qualité du code</span>:
...
## <span style="color: rgb(255 100 100)">Partie 5: Mettre en œuvre l es outils de la chaîne du DevOps</span>:
